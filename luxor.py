...
def main() -> None:
    ...
    print('Maximum 6 próbálkozásod van! Segítség: a programnyelv, amin íródott a program, egy kígyó nevét kapta.')
    jelszo = 'Python'
    bekeres = input('Írd be a jelszót:  ')
    probalkozas = 0

    while bekeres != jelszo:
        probalkozas += 1
        if probalkozas == 6:
            print('Túl sokszor próbálkoztál a jelszóval! A program futása leáll!')
            break
        print('Rossz jelszó, próbáld meg újra!')
        bekeres = input('Írd be a jelszót: ')
